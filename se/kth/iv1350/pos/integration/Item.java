...
public class Item {
     ...
     *
     * @param otherQuantity The {@link Amount} that will be added to the
     * quantity.
     */
     ...
     *
     * @param otherQuantity The {@link Amount} that will be subtracted to the
     * quantity.
     */
    ...
    /**
     * Two <code>Item</code> instances are equal if all fields are equal except
     * the .
     *
     ...
     * <code>Item</code> except quantity, <code>false</code> if they are not.
     */
    @Override
